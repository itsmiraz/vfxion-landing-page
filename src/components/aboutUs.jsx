...
export const AboutUs = () => {
    return (
        <div id="aboutUs" className="px-4 md:px-10">
            <div className="bg-[#0B0B0B] px-4 md:px-10 py-14 my-32  rounded-[30px] mt">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2  gap-8">
                    {
                        aboutUs_content.map((item, i) => <div key={i} className="px-4 py-7 bg-[#171717] drop-shadow-md shadow-inner rounded-[12px] ">
                            ...
                            <div>
                                ...
                                <p className="text-sm md:text-xl font-light text-[#C3C3C3] leading-[25.2px]">
                                    {item.desc}
                                </p>
                            </div>
                        </div>)
